...
# b.
# Task:
# Copy a file named photo.jpg into a directory called images.

# (Assume the directory already exists.)

# c.
# Task:
# Copy three files — a.js, b.js, and c.js — into a directory named scripts.

# d.
# Task:
# Copy a directory named project and all of its contents into a new directory called project_backup.
